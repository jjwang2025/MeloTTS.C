...
struct ModelConfig {
  ...
  /**
   * @brief Optional path to a custom G2P lexicon file.
   *
   * This lexicon is consulted before CMUdict and before built-in fallback rules.
   * It is intended for domain-specific vocabulary, acronyms, product names, and
   * terms generated by an external G2P tool such as `g2p-en`.
   */
